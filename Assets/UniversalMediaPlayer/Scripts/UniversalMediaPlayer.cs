...
#pragma warning restore 0414
    ...
    private void HandleOnPlayModeChanged(PlayModeStateChange modeState)
        ...
        public static float FrameRateBAK = 0.0f;
        public void Update()
        {
            if (_mediaPlayer.FrameRate != FrameRateBAK)
            {
                Log.i(CONSTANTS.TAG, "UMP FPS: " + _mediaPlayer.FrameRate);
                FrameRateBAK = _mediaPlayer.FrameRate;
            }
        }
    }
}