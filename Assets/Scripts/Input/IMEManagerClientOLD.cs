...
namespace Hubble.Launcher.Input
{
    ...
    public class IMEManagerClientOLD : MonoBehaviour, IPointerClickHandler
    {
        static private bool bDebug = false;
        private static string LOG_TAG = "IMEManagerClientOLD";
        ...
        void Start()
        {
            InputFieldComponent = GetComponent<InputField>();
        ...
        void OnDisable()
        {
            IMEManagerServerOLD.s_IMEManagerServer.hideKeyboard();
        }
        ...
        public void OnPointerClick(PointerEventData eventData)  // addListener() by IPointerClickHandler interface implementation in Script
        {
            ...
            int status = IMEManagerServerOLD.s_IMEManagerServer.getKeyboardStatus();
            IMEManagerServerOLD.s_IMEManagerServer.showKeyboard(gameObject);
        }
